  ...
  _createClass(RssFeedEmitter, [{
    ...
    value: function _createSetInterval(feed) {
      ...
      function getContent() {
        ...
        instance._fetchFeed(feed.url).then(findFeed).then(redefineItemHistoryMaxLength).then(sortItemsByDate).then(identifyOnlyNewItems).then(populateNewItemsInFeed).catch(function (error) {
